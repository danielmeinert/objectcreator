...
class PathGeneratorUi(QMainWindow):
    def __init__(self):
        ...
        self.colorSelectPanel = colorSelectWidget(self.active_shade, pal.orct, True, False, False)
    ...
    def loadFixMask(self):
        img = QtGui.QImage(":/images/res/fix_mask.png")
        buffer = QtCore.QBuffer()
        buffer.open(QtCore.QBuffer.ReadWrite)
        img.save(buffer, "PNG")
...
class ImportSpriteUi(QDialog):
    ...
    def loadFrame(self):
        img = QtGui.QImage(":/images/res/frame_import.png")
        buffer = QtCore.QBuffer()
        buffer.open(QtCore.QBuffer.ReadWrite)
        img.save(buffer, "PNG")
        self.frame_image = Image.open(io.BytesIO(buffer.data()))
    ...
    def loadFixMask(self):
        img = QtGui.QImage(":/images/res/import_mask.png")
        buffer = QtCore.QBuffer()
        buffer.open(QtCore.QBuffer.ReadWrite)
        img.save(buffer, "PNG")
