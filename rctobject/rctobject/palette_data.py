...
rct_data = np.array([
    ...
    [[8, 67, 8],  # Green remap
     ...
     [80, 219, 80],
     [88, 237, 88],
     [92, 255, 92]]], dtype=np.uint8)

original_sparkles_data = np.array(
...
orct_data = np.array(np.array_split(np.concatenate(
    (complete_palette_array[10: 226],
     complete_palette_array[243: 255])), 19))
orct_sparkles_data = complete_palette_array[230: 240]
